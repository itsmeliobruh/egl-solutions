...
async function seed() {
  ...
  const services = [
    {
      slug: 'website-and-systems', name: 'Growth Foundation', emoji: '🚀', category: 'systems' as const,
      ...
      included: [
        '10–15 page high-converting website or landing page','Lead capture form','Call button','Booking link',
        'CRM pipeline setup','Basic SMS/email follow-up automations','Google review request workflow',
        'Basic review capture system','Lead source tracking','Light monthly support',
      ].map(text => ({ text })),
    ...
    {
      slug: 'lead-generation', name: 'Lead Flow System', emoji: '🚀', category: 'systems' as const,
      ...
      included: [
        'Everything in Growth Foundation','Website or landing page','CRM setup','Lead capture',
        'Follow-up automations','Google review workflow','Lead source tracking',
        'Google Business Profile setup & optimization','Local Service Ads setup, if eligible',
        'Meta Ads setup','Google Ads setup, optional depending on industry','Offer-specific landing page',
        'Pixel setup','UTM tracking','Call tracking','Monthly performance report',
        'Leads, appointments, and cost per lead reporting','Weekly campaign adjustments',
      ].map(text => ({ text })),
    },
    {
      slug: 'all-in-one-system', name: 'Revenue Engine', emoji: '🚀', category: 'systems' as const,
      ...
      included: [
        'Everything in Lead Flow System','Website','Ads','CRM','Reporting','Advanced AI agents',
        'AI chat agent','Missed-call text-back','AI appointment setter',
        'AI receptionist (optional depending on niche)','Sales pipeline automations',
        'Lead reactivation campaign','Automated review engine','Email/SMS nurture',
        '1 filming day per month','8–12 edited short-form videos per month',
        'Monthly strategy call','Priority support',
      ].map(text => ({ text })),
    },
    {
      slug: 'content-foundation', name: 'Content Starter', emoji: '📸', category: 'content' as const,
    ...
    {
      slug: 'content-growth', name: 'Content Growth', emoji: '📸', category: 'content' as const,
    ...
    {
      slug: 'content-authority', name: 'Local Authority Content', emoji: '📸', category: 'content' as const,
      ...
      whyImportant: 'Authority in a local market is won by showing up consistently, everywhere, at scale.',
  ...
  console.log('✅ FAQ items (10)')

  console.log('\n🎉 Seed complete! Your CMS is fully loaded.')
  process.exit(0)
}
