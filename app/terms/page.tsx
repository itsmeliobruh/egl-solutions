...
export const metadata: Metadata = {
  title: 'Terms & Conditions | EGL Solutions',
  description: 'Terms and Conditions for EGL Solutions marketing services.',
    ...
    <section className="bg-void min-h-screen pt-32 pb-20 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none font-body text-muted space-y-6 text-sm leading-relaxed">
          ...
          <p>EGL Solutions provides digital marketing services including website design, lead generation, content creation, and marketing automation for local service businesses. All services are delivered on a month-to-month basis unless otherwise agreed in writing.</p>
          ...
          <p>Upon full payment of all outstanding balances, clients own the deliverables created specifically for their account. EGL Solutions retains ownership of all proprietary tools, systems, templates, and processes used in delivering services.</p>
          <h2 className="font-display text-2xl text-bone tracking-wide">5. SMS Communications</h2>
          <p>By providing your phone number, you consent to receive SMS messages from EGL Solutions regarding your account, our services, and marketing updates. Message frequency varies. Message and data rates may apply. Reply STOP to unsubscribe.</p>
          <h2 className="font-display text-2xl text-bone tracking-wide">6. Limitation of Liability</h2>
          <p>EGL Solutions shall not be liable for any indirect, incidental, or consequential damages. Our total liability shall not exceed the amounts paid by the client in the preceding month.</p>
